    ...
    <form action="insert.php" method="post">
        <div class="container container-form col-md-15">
            <div class="row justify-content-center shadow py-3 rounded-5">
                <div class="col-8">
                    <input type="text" name="list" class="form-control shadow" placeholder="What's on your mind?">
                </div>
                <div class="col-4">
                    <button class="btn btn-outline-info"><i class="fa-solid fa-plus fa-bounce"></i> ADD</button>
                </div>
            </div>
        </div>
    </form>
            ...
            <div class="col">
                <div class="card rounded-5">
                    <div class="card-body">
                        ...
                        <a href="halaman-update.php?ID=<?php echo $row['Id']; ?>" class="btn btn-outline-success">
                            <i class="fa-solid fa-arrow-up-from-bracket fa-beat-fade"></i> UPDATE</a>
                        <a href="delete.php?ID=<?php echo $row['Id']; ?>" class="btn btn-outline-danger">
                            <i class="fa-solid fa-trash-can fa-flip"></i> DELETE </a>
                    </div>
                </div>
            </div>
            <?php } ?>
